...
function on_active() {
  ...
  grad = document.getElementsByClassName('ytp-gradient-bottom')[0];
  ...
  video.onplay = function () {
    ...
    var inter = setInterval(function () {
      ...
      if (b[run]) {
        if (btn) {
          h1[1].style['padding'] = '16px';
          h1[1].style['font-weight'] = 'bold';
          h1[1].style['font-size'] = '20px';
          // h1[1].style['background-color'] = '#a0a0a0';
          h1[1].style['text-shadow'] = '2px 2px 3px rgba(255,255,255,0.2)';
          btn = false;
        }
        // grad.innerText = b[run];
        h1[1].innerText = b[run];
      }
    }, 1000);
